...
@interface Design_35_35_SpawnActoruponDeath : ActorScript 
{
	@public
		NSString* tempHolder;
...
@implementation Design_35_35_SpawnActoruponDeath
...
Design_35_35_SpawnActoruponDeath* self = (Design_35_35_SpawnActoruponDeath*) theScript;
                    [_SpawnedActor die];
}]];
}
