...
@interface Design_112_112_Health : ActorScript 
{
	@public
		NSString* tempHolder;
...
@implementation Design_112_112_Health
...
Design_112_112_Health* self = (Design_112_112_Health*) theScript;
        [mActor setActorValue:@"hitPoints" value:[NSNumber numberWithFloat:currHealth]];
        [mActor setActorValue:@"maxHealth" value:[NSNumber numberWithFloat:maxHealth]];
}];
...
{
            [self playSound:[self getSound:229]];
}
            ...
            if(dieOnDepletedHealth)
{
                if([self sameAs:[NSNumber numberWithFloat:[[self getGameAttribute:@"SoundEffectsOn"] floatValue]] two:[NSNumber numberWithFloat:1]])
{
                    [self playSound:[self getSound:230]];
}
