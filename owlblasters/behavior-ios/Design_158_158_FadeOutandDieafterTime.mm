...
@interface Design_158_158_FadeOutandDieafterTime : ActorScript 
{
	@public
		NSString* tempHolder;
...
@implementation Design_158_158_FadeOutandDieafterTime

-(void)load
{
	            [self doLater:1000 * _StartFadingAfter task:[self createRunnable:^(Runnable* parent, Script* theScript){
Design_158_158_FadeOutandDieafterTime* self = (Design_158_158_FadeOutandDieafterTime*) theScript;
