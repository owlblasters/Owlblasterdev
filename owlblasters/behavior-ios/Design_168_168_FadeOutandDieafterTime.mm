...
@interface Design_168_168_FadeOutandDieafterTime : ActorScript 
{
	@public
		NSString* tempHolder;
...
@implementation Design_168_168_FadeOutandDieafterTime

-(void)load
{
	            [self doLater:1000 * _StartFadingAfter task:[self createRunnable:^(Runnable* parent, Script* theScript){
Design_168_168_FadeOutandDieafterTime* self = (Design_168_168_FadeOutandDieafterTime*) theScript;
