...
@interface Design_14_14_SpawnActoruponDeath : ActorScript 
{
	@public
		NSString* tempHolder;
...
@implementation Design_14_14_SpawnActoruponDeath
...
Design_14_14_SpawnActoruponDeath* self = (Design_14_14_SpawnActoruponDeath*) theScript;
                    [_SpawnedActor die];
}]];
}
