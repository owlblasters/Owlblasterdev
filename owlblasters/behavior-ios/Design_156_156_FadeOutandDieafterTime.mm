...
@interface Design_156_156_FadeOutandDieafterTime : ActorScript 
{
	@public
		NSString* tempHolder;
...
@implementation Design_156_156_FadeOutandDieafterTime

-(void)load
{
	            [self doLater:1000 * _StartFadingAfter task:[self createRunnable:^(Runnable* parent, Script* theScript){
Design_156_156_FadeOutandDieafterTime* self = (Design_156_156_FadeOutandDieafterTime*) theScript;
