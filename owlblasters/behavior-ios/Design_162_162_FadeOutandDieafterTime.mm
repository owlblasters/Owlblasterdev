...
@interface Design_162_162_FadeOutandDieafterTime : ActorScript 
{
	@public
		NSString* tempHolder;
...
@implementation Design_162_162_FadeOutandDieafterTime

-(void)load
{
	            [self doLater:1000 * _StartFadingAfter task:[self createRunnable:^(Runnable* parent, Script* theScript){
Design_162_162_FadeOutandDieafterTime* self = (Design_162_162_FadeOutandDieafterTime*) theScript;
