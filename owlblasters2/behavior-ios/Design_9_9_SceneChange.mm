...
@interface Design_9_9_SceneChange : ActorScript 
{
	@public
		NSString* tempHolder;
...
@implementation Design_9_9_SceneChange
...
Design_9_9_SceneChange* self = (Design_9_9_SceneChange*) theScript;
        ...
        if(_ispressed)
{
            ...
            [self switchScene:_changeto.ID leave:[self createFadeOut:((1000*.1)) color:0] enter:[self createFadeIn:((1000*.1)) color:0]];
}
